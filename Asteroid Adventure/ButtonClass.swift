...
class ButtonClass: SKCropNode {
    
    private var Title = ""
    
    private let Background = SKSpriteNode(color: UIColor.whiteColor(), size: CGSize(width: 0, height: 0))
    ...
    override func touchesBegan(touches: Set<UITouch>, withEvent event: UIEvent?) {
        ...
        RightBorder.color = UIColor.grayColor()
        LeftBorder.color = UIColor.grayColor()
    ...
    override func touchesEnded(touches: Set<UITouch>, withEvent event: UIEvent?) {
        ...
        LeftBorder.color = UIColor.whiteColor()
        RightBorder.color = UIColor.whiteColor()
        Titlelabel.fontColor = UIColor.whiteColor()
